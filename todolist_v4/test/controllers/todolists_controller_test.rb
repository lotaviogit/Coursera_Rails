...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { list_due_date: @todolist.list_due_date, list_name: @todolist.list_name, user_id: @todolist.user_id } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { list_due_date: @todolist.list_due_date, list_name: @todolist.list_name, user_id: @todolist.user_id } }
