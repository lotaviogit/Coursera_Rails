...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { cost: @day.cost, day: @day.day, description: @day.description, month: @day.month, year: @day.year } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { cost: @day.cost, day: @day.day, description: @day.description, month: @day.month, year: @day.year } }
